...
?>
<?php
  $crockery_store_content = apply_filters( 'the_content', get_the_content() );
  $audio = false;

  // Only get audio from the content if a playlist isn't present.
  if ( false === strpos( $crockery_store_content, 'wp-playlist-script' ) ) {
    $audio = get_media_embedded_in_content( $crockery_store_content, array( 'audio' ) );
  }
?>
